...
declare global {
  ...
  const useUsersStore: typeof import('../views/pages/users/stores/users')['useUsersStore']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useUsersStore: UnwrapRef<typeof import('../views/pages/users/stores/users')['useUsersStore']>
